...
def create_question(question_text,days=0, end_date=None):
    ...
    if end_date is not None:
        end = timezone.now() + datetime.timedelta(days=end_date)
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_questions(self):
        ...
        question1.pub_date = timezone.now() - datetime.timedelta(days=30)
        question2 = create_question(question_text="Past question 2.")
        question2.pub_date = timezone.now() - datetime.timedelta(days=5)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question2, question1],
...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        ...
        future_question.pub_date = timezone.now() + datetime.timedelta(days=30)
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        old_question.pub_date = timezone.now() - datetime.timedelta(days=1, seconds=1)
    ...
    def test_future_pub_date(self):
        ...
        future_question.pub_date = timezone.now() + datetime.timedelta(days=4)
    ...
    def test_past_pub_date(self):
        ...
        past_question.pub_date = timezone.now() - datetime.timedelta(days=1)
    ...
    def test_can_vote_when_within_voting_period(self):
        ...
        """
        question = create_question(question_text='One day polls',
                                   end_date=3)
    ...
    def test_cannot_vote_before_pub_date(self):
        ...
        """
        future_question = create_question(question_text='Future Question')
        future_question.pub_date = timezone.now() + datetime.timedelta(days=1)
    ...
    def test_cannot_vote_after_end_date(self):
        ...
        expired_question = create_question(question_text='Expired Question',
                                           end_date=-1)
        expired_question.pub_date = timezone.now() - datetime.timedelta(days=3)
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        ...
        """
        future_question = create_question(question_text='Future question.')
        future_question.pub_date = timezone.now() + datetime.timedelta(days=5)
    ...
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text='Past Question.')
        past_question.pub_date = timezone.now() - datetime.timedelta(days=5)
